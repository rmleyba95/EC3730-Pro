...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{figures/ifstatus_wan1.png}}
\caption{WAN interface successfully obtaining a DHCP address from the upstream router.}
\label{fig:wan_dhcp}
\end{figure}
\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{figures/ifstatus_wan2.png}}
\caption{WAN interface successfully obtaining a DHCP address from the upstream router.}
\label{fig:wan_dhcp2}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{figures/ping_8_8_8_8.png}}
\caption{Successful Internet connectivity verification from the LibreMesh gateway node.}
\label{fig:internet_ping}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{figures/ip_neigh_phone_connected.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{figures/ip_neigh_phone_connected_phone.png}}
\caption{Neighbor table showing a wireless client connected to the LibreMesh access point and participating in the mesh network.}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{figures/iw_phy_supported_modes.png}}
